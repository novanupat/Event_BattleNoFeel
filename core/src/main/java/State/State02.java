 ...
 */
public class State02 extends UIScreen {
    ...
    public void wasAdded() {
        ...
        if (showDebugDraw){
            CanvasImage image = graphics().createImage(
                    (int)(width / State02.M_PER_PIXEL),
                    (int)(height / State02.M_PER_PIXEL));
            ...
            debugDraw.setCamera(0,0,1f/ State02.M_PER_PIXEL);
    ...
    public void update(final int delta) {
        ...
        if (rootOpenAmount){
            ...
            root.add(new Label("Amount "+MyGame.amount).addStyles(Style.FONT.is(State02.TITLE_FONT)));
        ...
        if (rootOpenGunLv){
            ...
            root1.add(new Label("Weapon Lv. "+Shop.levelGun).addStyles(Style.FONT.is(State02.TITLE_FONT)));
            rootOpenGunLv = false;
        }
        ...
        if (rootOpenCoin){
            ...
            root2.add(new Label("Money "+MyGame.coin).addStyles(Style.FONT.is(State02.TITLE_FONT)));
            rootOpenCoin = false;
        }
