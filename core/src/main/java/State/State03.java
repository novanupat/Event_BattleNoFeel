 ...
 */
public class State03 extends UIScreen {
    ...
    public void wasAdded() {
            ...
            public void beginContact(Contact contact) {
                ...
                if ((attackZealot)){
                    ...
                    /*if(contact.getFixtureB().getBody() == enemy01.body) {
                        b.contact(contact);
                        enemy01.contact4(contact);
                        System.out.println("111111111111111112");
                    }
                    if(contact.getFixtureA().getBody() == enemy01.body) {
                        b.contact(contact);
                        enemy01.contact4(contact);
        ...
        if (showDebugDraw){
            CanvasImage image = graphics().createImage(
                    (int)(width / State03.M_PER_PIXEL),
                    (int)(height / State03.M_PER_PIXEL));
            ...
            debugDraw.setCamera(0,0,1f/ State03.M_PER_PIXEL);
    ...
    public void update(final int delta) {
        ...
        if (rootOpenAmount){
            ...
            root.add(new Label("Amount "+MyGame.amount).addStyles(Style.FONT.is(State03.TITLE_FONT)));
        ...
        if (rootOpenGunLv){
            ...
            root1.add(new Label("Weapon Lv. "+Shop.levelGun).addStyles(Style.FONT.is(State03.TITLE_FONT)));
            rootOpenGunLv = false;
        }
        ...
        if (rootOpenCoin){
            ...
            root2.add(new Label("Money "+MyGame.coin).addStyles(Style.FONT.is(State03.TITLE_FONT)));
            rootOpenCoin = false;
        }
